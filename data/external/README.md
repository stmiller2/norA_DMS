...
- **`computational_stability.csv`** : Combined csv containing ΔΔG values for each conformation, predicted by both Rosetta and ThermoMPNN. See relevant analysis script [here](../../scripts/04_analyses/supplementary/figS13_hotspots_plots.py); Results [here](../../results/supplementary/figS13_hotspots/) and [here](../../results/supplementary/tableS02_hotspots/).
#### Other data:
