...
- **[`specificity_clean.pk1`](specificity_clean.pk1)** : Pickled python dictionary containing all specificity functional score data, produced using [combine_dfs.py](../../../scripts/03_functional_scoring/specificity/combine_dfs.py).
