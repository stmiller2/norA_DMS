...
sample_dict ={}
sample_dict['A'] = ['nor0048-sel', 'h2o-sel']
sample_dict['B'] = ['acr20-sel', 'tpp9-sel']
sample_dict['E'] = ['ofl0008-sel', 'ppa156-sel2']
sample_dict['G'] = ['eth6-sel']
sample_dict['H'] = ['pen25-sel', 'pur48-sel']
...
sample_names = ['inpA-rep1', 'inpA-rep2',
                'inpB-rep1', 'inpB-rep2',
                'inpE-rep1', 'inpE-rep2',
                'inpG-rep1', 'inpG-rep2',
                'inpH-rep1', 'inpH-rep2',
                'nor0048-sel-rep1', 'nor0048-sel-rep2',
                'h2o-sel-rep1', 'h2o-sel-rep2'
                'acr20-sel-rep1', 'acr20-sel-rep2',
                'tpp9-sel-rep1', 'tpp9-sel-rep2',
                'ofl0008-sel-rep1', 'ofl0008-sel-rep2',
                'ppa156-sel2-rep1', 'ppa156-sel2-rep2',
                'eth6-sel-rep1', 'eth6-sel-rep2',
                'pen25-sel-rep1', 'pen25-sel-rep2',
                'pur48-sel-rep1', 'pur48-sel-rep2']
...
for name in sample_names:
    ...
    raw = pd.read_csv(f'{base_dir}/data/processed/specificity/good_reads/good_reads_{name}.csv', names = ['read'])
    ngs.end_time()
    ...
    #Save csvs
    bc_counts.to_csv(f'{base_dir}/data/processed/specificity/barcode_counts/bc_counts_{name}.csv', index = False)
    counts[name].to_csv(f'{base_dir}/data/processed/specificity/variant_counts/var_counts_{name}.csv', index = False)
...
#counts = {}
#for name in sample_names:
#    counts[name] = pd.read_csv(f'{base_dir}/data/processed/specificity/variant_counts/var_counts_{name}.csv')
...
for condition in conditions:
    ...
    fig.savefig(f'{base_dir}/data/processed/specificity/scoring_figs/frequency_correlations/frequency_corr_{condition}.png',
...
for input_lib in [con for con in conditions if 'inp' in con]:
    ...
    r2 = counts[f'{input_lib}-rep2']['counts']/counts[f'{input_lib}-rep2']['counts'].sum()
    ...
    fig.savefig(f'{base_dir}/data/processed/specificity/scoring_figs/input_distributions/input_dist_{input_lib}.png',
                dpi = 200, bbox_inches = 'tight')
    
    ax.set_xscale('log')
    fig.savefig(f'{base_dir}/data/processed/specificity/scoring_figs/input_distributions/input_dist_log_{input_lib}.png',
                dpi = 200, bbox_inches = 'tight')
...
for selection in selections:
    ...
    scores[f'{selection}-rep1'].to_csv(f'{base_dir}/data/processed/specificity/replicate_functional_scores/{selection}-rep1.csv', index = False)
    scores[f'{selection}-rep2'].to_csv(f'{base_dir}/data/processed/specificity/replicate_functional_scores/{selection}-rep2.csv', index = False)
...
#scores = {}
#for selection in selections:
#    scores[f'{selection}-rep1'] = pd.read_csv(f'{base_dir}/data/processed/specificity/replicate_functional_scores/{selection}-rep1.csv')
#    scores[f'{selection}-rep2'] = pd.read_csv(f'{base_dir}/data/processed/specificity/replicate_functional_scores/{selection}-rep2.csv')
...
for selection in selections:
    ...
    fig.savefig(f'{base_dir}/data/processed/specificity/scoring_figs/score_correlations/score_corr_{selection}.png',
                dpi = 200, bbox_inches = 'tight')
...
for selection in selections:
    ...
    final[selection].to_csv(f'{base_dir}/data/processed/specificity/final_functional_scores/{selection}.csv', index = False)
